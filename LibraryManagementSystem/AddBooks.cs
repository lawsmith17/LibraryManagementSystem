...
namespace LibraryManagementSystem
{
    public partial class AddBooks : UserControl
    {
        ...
        //Loading an image to the addBooks piture box
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string path = Path.Combine(@"C:\Users\lawrence\source\repos\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\" +
        ...
        //displaying the books on the form
        ...
        //populating text boxs with the information selected on the GridView
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                if (imagePath != null || imagePath.Length >= 1)
                {
                    ...
                    {
                        addBooks_picture.Image = Image.FromFile(@"C:\Users\lawrence\source\repos\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\gcb.jpg");
                    }
